          ...
          <Navbar.Collapse>
            ...
            <Nav className="me-auto">
              <NavDropdown title="Towns" id="appnavbar-towns" data-testid="appnavbar-towns" >
                <NavDropdown.Item as={Link} to="/towns/NewportBeach">Newport Beach</NavDropdown.Item>
                ...
                <NavDropdown.Item as={Link} to="/towns/QuartzHill">Quartz Hill</NavDropdown.Item>
                ...
                <NavDropdown.Item as={Link} to="/towns/LonePine">Lone Pine</NavDropdown.Item>
